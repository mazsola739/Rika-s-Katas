...
depending on the number of students he must train in the morning. He is curious how many stairs might be climbed over the next 20 
...
function stairsIn20(s) {
  return (
    s
      .map((subarr) =>
        subarr.reduce((subsum, subitem) => (subsum += subitem), 0)
      )
      .reduce((sum, item) => (sum += item), 0) * 20
  );
}
